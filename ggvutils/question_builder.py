...
workhseet = []    
for i in data:
	q = {} # i.get('WID'), i.get('QUESTION'), i.get('QUESTION DISPLAY ORDER')
	q['worksheet'] = i.get('WID')
	q['question'] = i.get('QUESTION')
	q['rank'] = i.get('QUESTION DISPLAY ORDER')
	correct =('CORRECT', i.get('CORRECT ANSWER'))
	qtype = i.get('SELECT TYPE')
	...
	if qtype == 'text':
		...
		qt = 'OPTIONS', correct, q
		print qt
		print 'OPTIONS TUPLE: %s' % opts
