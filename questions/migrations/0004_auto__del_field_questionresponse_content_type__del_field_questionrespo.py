...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'QuestionResponse.content_type'
        db.delete_column(u'questions_questionresponse', 'content_type_id')

        # Deleting field 'QuestionResponse.object_id'
        db.delete_column(u'questions_questionresponse', 'object_id')

        # Adding field 'QuestionResponse.question_type'
        db.add_column(u'questions_questionresponse', 'question_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=19, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'QuestionResponse.question_id'
        db.add_column(u'questions_questionresponse', 'question_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'QuestionResponse.content_type'
        db.add_column(u'questions_questionresponse', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=19, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'QuestionResponse.object_id'
        db.add_column(u'questions_questionresponse', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'QuestionResponse.question_type'
        db.delete_column(u'questions_questionresponse', 'question_type_id')

        # Deleting field 'QuestionResponse.question_id'
        db.delete_column(u'questions_questionresponse', 'question_id')
