...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuestionSet.activity_type'
        db.alter_column(u'questions_questionset', 'activity_type', self.gf('django.db.models.fields.CharField')(max_length=48, null=True))

    def backwards(self, orm):

        # Changing field 'QuestionSet.activity_type'
        db.alter_column(u'questions_questionset', 'activity_type', self.gf('django.db.models.fields.CharField')(max_length=48))
