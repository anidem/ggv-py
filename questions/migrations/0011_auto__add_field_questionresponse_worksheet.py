...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionResponse.worksheet'
        db.add_column(u'questions_questionresponse', 'worksheet',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['questions.QuestionSet']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionResponse.worksheet'
        db.delete_column(u'questions_questionresponse', 'worksheet_id')
    ...
    models = {
        ...
        u'questions.questionresponse': {
            ...
            'worksheet': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['questions.QuestionSet']"})
        },
