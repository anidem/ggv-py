...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SlideStack.activity_type'
        db.add_column(u'slidestacks_slidestack', 'activity_type',
                      self.gf('django.db.models.fields.CharField')(default='slidestack', max_length=48),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SlideStack.activity_type'
        db.delete_column(u'slidestacks_slidestack', 'activity_type')
    ...
    models = {
        ...
        u'slidestacks.slidestack': {
            ...
            'activity_type': ('django.db.models.fields.CharField', [], {'default': "'slidestack'", 'max_length': '48'}),
